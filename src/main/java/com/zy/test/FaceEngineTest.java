...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        String appId = "7jCcTpoeDWVhH3E2Y4M8RdH6VXe3CgrernPnANKF38K";
        String sdkKey = "AHyJGdpjjNa5uU7JRskibSffSifcKfCaNdkNVH9rXQ67";

        FaceEngine faceEngine = new FaceEngine("F:\\java\\jar\\face++\\libs\\WIN64");
        //激活引擎
        ...
        //人脸检测
        ImageInfo imageInfo = getRGBData(new File("F:\\git\\zhypp\\images\\3.jpg"));
        ...
        //人脸检测2
        ImageInfo imageInfo2 = getRGBData(new File("F:\\git\\zhypp\\images\\img_1.jpg"));
        ...
        //assertEquals(genderCode, ErrorInfo.MOK.getValue());
        ...
        //IR属性处理
        ImageInfo imageInfoGray = getGrayData(new File("F:\\git\\zhypp\\images\\img_1.jpg"));
